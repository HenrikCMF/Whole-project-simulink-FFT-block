-- -------------------------------------------------------------
-- 
-- File Name: C:\dokumenter\FFTblock\simulinktest\SDFCommutator2.vhd
...
-- Source Path: simulinktest/FFT_block/FFT HDL Optimized/RADIX22FFT_SDF2_2/SDFCommutator2
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF SDFCommutator2 IS
  ...
  SIGNAL dinf_re_signed                   : signed(25 DOWNTO 0);  -- sfix26
  SIGNAL dinf_im_signed                   : signed(25 DOWNTO 0);  -- sfix26
  ...
  SIGNAL dout_2_1_re_tmp                  : signed(25 DOWNTO 0);  -- sfix26
  SIGNAL dout_2_1_im_tmp                  : signed(25 DOWNTO 0);  -- sfix26
