-- -------------------------------------------------------------
-- 
-- File Name: C:\dokumenter\FFTblock\simulinktest\SDFCommutator4.vhd
...
-- Source Path: simulinktest/FFT_block/FFT HDL Optimized/RADIX22FFT_SDF2_4/SDFCommutator4
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF SDFCommutator4 IS
  ...
  -- Signals
  SIGNAL xf_re_signed                     : signed(27 DOWNTO 0);  -- sfix28
  SIGNAL xf_im_signed                     : signed(27 DOWNTO 0);  -- sfix28
  SIGNAL dinf_re_signed                   : signed(27 DOWNTO 0);  -- sfix28
  SIGNAL dinf_im_signed                   : signed(27 DOWNTO 0);  -- sfix28
  SIGNAL btf1_re_signed                   : signed(27 DOWNTO 0);  -- sfix28
  SIGNAL btf1_im_signed                   : signed(27 DOWNTO 0);  -- sfix28
  SIGNAL btf2_re_signed                   : signed(27 DOWNTO 0);  -- sfix28
  SIGNAL btf2_im_signed                   : signed(27 DOWNTO 0);  -- sfix28
  ...
  SIGNAL SDFCummutator_out_re_next        : signed(27 DOWNTO 0);  -- sfix28
  SIGNAL SDFCummutator_out_im_next        : signed(27 DOWNTO 0);  -- sfix28
  ...
  SIGNAL SDFCummutator_wrData_re_reg_next : signed(27 DOWNTO 0);  -- sfix28
  SIGNAL SDFCummutator_wrData_im_reg_next : signed(27 DOWNTO 0);  -- sfix28
  SIGNAL SDFCummutator_wrEnb_reg_next     : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg_next : signed(27 DOWNTO 0);  -- sfix28
  SIGNAL SDFCummutator_wrXData_im_reg_next : signed(27 DOWNTO 0);  -- sfix28
  ...
  SIGNAL wrData_re_tmp                    : signed(27 DOWNTO 0);  -- sfix28
  SIGNAL wrData_im_tmp                    : signed(27 DOWNTO 0);  -- sfix28
  SIGNAL wrAddr_tmp                       : unsigned(4 DOWNTO 0);  -- ufix5
  SIGNAL xData_re                         : signed(27 DOWNTO 0);  -- sfix28
  SIGNAL xData_im                         : signed(27 DOWNTO 0);  -- sfix28
  ...
  SIGNAL dout0_re                         : signed(27 DOWNTO 0);  -- sfix28
  SIGNAL dout0_im                         : signed(27 DOWNTO 0);  -- sfix28
  SIGNAL dout0_vld                        : std_logic;
  SIGNAL xX_re                            : std_logic_vector(27 DOWNTO 0);  -- ufix28
  SIGNAL xX_re_signed                     : signed(27 DOWNTO 0);  -- sfix28
  SIGNAL xX_im                            : std_logic_vector(27 DOWNTO 0);  -- ufix28
  SIGNAL xX_im_signed                     : signed(27 DOWNTO 0);  -- sfix28
  ...
  SIGNAL SDFOutmux_btf2Pipe_re_next       : signed(27 DOWNTO 0);  -- sfix28
  SIGNAL SDFOutmux_btf2Pipe_im_next       : signed(27 DOWNTO 0);  -- sfix28
  SIGNAL SDFOutmux_btfPipe_vld_next       : std_logic;
  SIGNAL dout_4_1_re_tmp                  : signed(27 DOWNTO 0);  -- sfix28
  SIGNAL dout_4_1_im_tmp                  : signed(27 DOWNTO 0);  -- sfix28
