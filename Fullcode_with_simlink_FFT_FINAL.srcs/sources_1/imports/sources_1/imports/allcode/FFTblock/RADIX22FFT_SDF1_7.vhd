-- -------------------------------------------------------------
-- 
-- File Name: C:\dokumenter\FFTblock\simulinktest\RADIX22FFT_SDF1_7.vhd
...
-- Source Path: simulinktest/FFT_block/FFT HDL Optimized/RADIX22FFT_SDF1_7
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF RADIX22FFT_SDF1_7 IS
  ...
  COMPONENT Complex4Multiply_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          din_re                          :   IN    std_logic_vector(30 DOWNTO 0);  -- sfix31
          din_im                          :   IN    std_logic_vector(30 DOWNTO 0);  -- sfix31
          din_7_vld_dly                   :   IN    std_logic;
          twdl_7_1_re                     :   IN    std_logic_vector(23 DOWNTO 0);  -- sfix24_En22
          twdl_7_1_im                     :   IN    std_logic_vector(23 DOWNTO 0);  -- sfix24_En22
          dinXTwdl_re                     :   OUT   std_logic_vector(30 DOWNTO 0);  -- sfix31
          dinXTwdl_im                     :   OUT   std_logic_vector(30 DOWNTO 0);  -- sfix31
          dinXTwdl_7_1_vld                :   OUT   std_logic
          );
  END COMPONENT;
  ...
  COMPONENT SDFCommutator7
    PORT( clk                             :   IN    std_logic;
          ...
          enb                             :   IN    std_logic;
          din_7_vld_dly                   :   IN    std_logic;
          xf_re                           :   IN    std_logic_vector(30 DOWNTO 0);  -- sfix31
          xf_im                           :   IN    std_logic_vector(30 DOWNTO 0);  -- sfix31
          xf_vld                          :   IN    std_logic;
          dinXTwdlf_re                    :   IN    std_logic_vector(30 DOWNTO 0);  -- sfix31
          dinXTwdlf_im                    :   IN    std_logic_vector(30 DOWNTO 0);  -- sfix31
          dinxTwdlf_vld                   :   IN    std_logic;
          btf1_re                         :   IN    std_logic_vector(30 DOWNTO 0);  -- sfix31
          btf1_im                         :   IN    std_logic_vector(30 DOWNTO 0);  -- sfix31
          btf2_re                         :   IN    std_logic_vector(30 DOWNTO 0);  -- sfix31
          btf2_im                         :   IN    std_logic_vector(30 DOWNTO 0);  -- sfix31
          btf_vld                         :   IN    std_logic;
          wrData_re                       :   OUT   std_logic_vector(30 DOWNTO 0);  -- sfix31
          wrData_im                       :   OUT   std_logic_vector(30 DOWNTO 0);  -- sfix31
  ...
  -- Signals
  SIGNAL din_7_1_re_dly_signed            : signed(29 DOWNTO 0);  -- sfix30
  SIGNAL din_re                           : signed(30 DOWNTO 0);  -- sfix31
  SIGNAL din_7_1_im_dly_signed            : signed(29 DOWNTO 0);  -- sfix30
  SIGNAL din_im                           : signed(30 DOWNTO 0);  -- sfix31
  ...
  SIGNAL dinXTwdl_re_signed               : signed(30 DOWNTO 0);  -- sfix31
  SIGNAL dinXTwdl_im_signed               : signed(30 DOWNTO 0);  -- sfix31
  SIGNAL x_vld                            : std_logic;
  SIGNAL btf2_im                          : signed(30 DOWNTO 0);  -- sfix31
  SIGNAL btf2_re                          : signed(30 DOWNTO 0);  -- sfix31
  SIGNAL btf1_im                          : signed(30 DOWNTO 0);  -- sfix31
  SIGNAL btf1_re                          : signed(30 DOWNTO 0);  -- sfix31
  SIGNAL dinXTwdlf_im                     : signed(30 DOWNTO 0);  -- sfix31
  SIGNAL dinXTwdlf_re                     : signed(30 DOWNTO 0);  -- sfix31
  SIGNAL xf_im                            : signed(30 DOWNTO 0);  -- sfix31
  ...
  SIGNAL xf_re                            : signed(30 DOWNTO 0);  -- sfix31
  SIGNAL xf_vld                           : std_logic;
  SIGNAL dinxTwdlf_vld                    : std_logic;
  SIGNAL btf_vld                          : std_logic;
  SIGNAL dout_7_1_re_tmp                  : std_logic_vector(30 DOWNTO 0);  -- ufix31
  SIGNAL dout_7_1_im_tmp                  : std_logic_vector(30 DOWNTO 0);  -- ufix31
...
BEGIN
  u_MUL4 : Complex4Multiply_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              din_re => std_logic_vector(din_re),  -- sfix31
              din_im => std_logic_vector(din_im),  -- sfix31
              din_7_vld_dly => din_7_vld_dly,
              twdl_7_1_re => twdl_7_1_re,  -- sfix24_En22
              twdl_7_1_im => twdl_7_1_im,  -- sfix24_En22
              dinXTwdl_re => dinXTwdl_re,  -- sfix31
              dinXTwdl_im => dinXTwdl_im,  -- sfix31
  ...
  u_SDFCOMMUTATOR_7 : SDFCommutator7
    PORT MAP( clk => clk,
              ...
              enb => enb,
              din_7_vld_dly => din_7_vld_dly,
              xf_re => std_logic_vector(xf_re),  -- sfix31
              xf_im => std_logic_vector(xf_im),  -- sfix31
              xf_vld => xf_vld,
              dinXTwdlf_re => std_logic_vector(dinXTwdlf_re),  -- sfix31
              dinXTwdlf_im => std_logic_vector(dinXTwdlf_im),  -- sfix31
              dinxTwdlf_vld => dinxTwdlf_vld,
              btf1_re => std_logic_vector(btf1_re),  -- sfix31
              btf1_im => std_logic_vector(btf1_im),  -- sfix31
              btf2_re => std_logic_vector(btf2_re),  -- sfix31
              btf2_im => std_logic_vector(btf2_im),  -- sfix31
              btf_vld => btf_vld,
              wrData_re => wrData_re,  -- sfix31
              wrData_im => wrData_im,  -- sfix31
              wrAddr => wrAddr,  -- ufix2
              wrEnb => wrEnb,
              dout_7_1_re => dout_7_1_re_tmp,  -- sfix31
              dout_7_1_im => dout_7_1_im_tmp,  -- sfix31
              dout_7_1_vld => dout_7_1_vld
              );

  din_7_1_re_dly_signed <= signed(din_7_1_re_dly);

  din_re <= resize(din_7_1_re_dly_signed, 31);

  din_7_1_im_dly_signed <= signed(din_7_1_im_dly);

  din_im <= resize(din_7_1_im_dly_signed, 31);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        ...
        Radix22ButterflyG1_btf1_re_reg <= resize(Radix22ButterflyG1_x_re_dly1, 32) + resize(Radix22ButterflyG1_dinXtwdl_re_dly2, 32);
        Radix22ButterflyG1_btf2_re_reg <= resize(Radix22ButterflyG1_x_re_dly1, 32) - resize(Radix22ButterflyG1_dinXtwdl_re_dly2, 32);
        Radix22ButterflyG1_btf1_im_reg <= resize(Radix22ButterflyG1_x_im_dly1, 32) + resize(Radix22ButterflyG1_dinXtwdl_im_dly2, 32);
        Radix22ButterflyG1_btf2_im_reg <= resize(Radix22ButterflyG1_x_im_dly1, 32) - resize(Radix22ButterflyG1_dinXtwdl_im_dly2, 32);
