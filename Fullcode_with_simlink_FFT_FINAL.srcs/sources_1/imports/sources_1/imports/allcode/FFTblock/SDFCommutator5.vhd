-- -------------------------------------------------------------
-- 
-- File Name: C:\dokumenter\FFTblock\simulinktest\SDFCommutator5.vhd
...
-- Source Path: simulinktest/FFT_block/FFT HDL Optimized/RADIX22FFT_SDF1_5/SDFCommutator5
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF SDFCommutator5 IS
  ...
  -- Signals
  SIGNAL xf_re_signed                     : signed(28 DOWNTO 0);  -- sfix29
  SIGNAL xf_im_signed                     : signed(28 DOWNTO 0);  -- sfix29
  SIGNAL dinXTwdlf_re_signed              : signed(28 DOWNTO 0);  -- sfix29
  SIGNAL dinXTwdlf_im_signed              : signed(28 DOWNTO 0);  -- sfix29
  SIGNAL btf1_re_signed                   : signed(28 DOWNTO 0);  -- sfix29
  SIGNAL btf1_im_signed                   : signed(28 DOWNTO 0);  -- sfix29
  SIGNAL btf2_re_signed                   : signed(28 DOWNTO 0);  -- sfix29
  SIGNAL btf2_im_signed                   : signed(28 DOWNTO 0);  -- sfix29
  ...
  SIGNAL SDFCummutator_out_re_next        : signed(28 DOWNTO 0);  -- sfix29
  SIGNAL SDFCummutator_out_im_next        : signed(28 DOWNTO 0);  -- sfix29
  ...
  SIGNAL SDFCummutator_wrData_re_reg_next : signed(28 DOWNTO 0);  -- sfix29
  SIGNAL SDFCummutator_wrData_im_reg_next : signed(28 DOWNTO 0);  -- sfix29
  SIGNAL SDFCummutator_wrEnb_reg_next     : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg_next : signed(28 DOWNTO 0);  -- sfix29
  SIGNAL SDFCummutator_wrXData_im_reg_next : signed(28 DOWNTO 0);  -- sfix29
  ...
  SIGNAL wrData_re_tmp                    : signed(28 DOWNTO 0);  -- sfix29
  SIGNAL wrData_im_tmp                    : signed(28 DOWNTO 0);  -- sfix29
  SIGNAL wrAddr_tmp                       : unsigned(3 DOWNTO 0);  -- ufix4
  SIGNAL xData_re                         : signed(28 DOWNTO 0);  -- sfix29
  SIGNAL xData_im                         : signed(28 DOWNTO 0);  -- sfix29
  ...
  SIGNAL dout0_re                         : signed(28 DOWNTO 0);  -- sfix29
  SIGNAL dout0_im                         : signed(28 DOWNTO 0);  -- sfix29
  SIGNAL dout0_vld                        : std_logic;
  SIGNAL xX_re                            : std_logic_vector(28 DOWNTO 0);  -- ufix29
  SIGNAL xX_re_signed                     : signed(28 DOWNTO 0);  -- sfix29
  SIGNAL xX_im                            : std_logic_vector(28 DOWNTO 0);  -- ufix29
  SIGNAL xX_im_signed                     : signed(28 DOWNTO 0);  -- sfix29
  ...
  SIGNAL SDFOutmux_btf2Pipe_re_next       : signed(28 DOWNTO 0);  -- sfix29
  SIGNAL SDFOutmux_btf2Pipe_im_next       : signed(28 DOWNTO 0);  -- sfix29
  SIGNAL SDFOutmux_btfPipe_vld_next       : std_logic;
  SIGNAL dout_5_1_re_tmp                  : signed(28 DOWNTO 0);  -- sfix29
  SIGNAL dout_5_1_im_tmp                  : signed(28 DOWNTO 0);  -- sfix29
