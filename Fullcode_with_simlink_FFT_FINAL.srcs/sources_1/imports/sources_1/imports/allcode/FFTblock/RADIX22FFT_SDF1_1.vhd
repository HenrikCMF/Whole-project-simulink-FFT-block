-- -------------------------------------------------------------
-- 
-- File Name: C:\dokumenter\FFTblock\simulinktest\RADIX22FFT_SDF1_1.vhd
...
-- Source Path: simulinktest/FFT_block/FFT HDL Optimized/RADIX22FFT_SDF1_1
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF RADIX22FFT_SDF1_1 IS
  ...
  COMPONENT SDFCommutator1
    PORT( clk                             :   IN    std_logic;
          ...
          xf_vld                          :   IN    std_logic;
          dinXTwdlf_re                    :   IN    std_logic_vector(24 DOWNTO 0);  -- sfix25
          dinXTwdlf_im                    :   IN    std_logic_vector(24 DOWNTO 0);  -- sfix25
  ...
  -- Signals
  SIGNAL din_1_1_re_dly_signed            : signed(23 DOWNTO 0);  -- sfix24
  SIGNAL din_re                           : signed(24 DOWNTO 0);  -- sfix25
  SIGNAL dinXTwdl_re                      : signed(24 DOWNTO 0);  -- sfix25
  SIGNAL din_1_1_im_dly_signed            : signed(23 DOWNTO 0);  -- sfix24
  SIGNAL din_im                           : signed(24 DOWNTO 0);  -- sfix25
  SIGNAL dinXTwdl_im                      : signed(24 DOWNTO 0);  -- sfix25
  ...
  SIGNAL dinXTwdlf_im                     : signed(24 DOWNTO 0);  -- sfix25
  SIGNAL dinXTwdlf_re                     : signed(24 DOWNTO 0);  -- sfix25
  ...
  SIGNAL x_re_signed                      : signed(24 DOWNTO 0);  -- sfix25
  ...
  SIGNAL dout_1_1_re_tmp                  : std_logic_vector(24 DOWNTO 0);  -- ufix25
  SIGNAL dout_1_1_im_tmp                  : std_logic_vector(24 DOWNTO 0);  -- ufix25
...
BEGIN
  ...
  u_SDFCOMMUTATOR_1 : SDFCommutator1
    PORT MAP( clk => clk,
              ...
              xf_vld => xf_vld,
              dinXTwdlf_re => std_logic_vector(dinXTwdlf_re),  -- sfix25
              dinXTwdlf_im => std_logic_vector(dinXTwdlf_im),  -- sfix25
              ...
              wrAddr => wrAddr,  -- ufix8
              wrEnb => wrEnb,
              dout_1_1_re => dout_1_1_re_tmp,  -- sfix25
              dout_1_1_im => dout_1_1_im_tmp,  -- sfix25
              dout_1_1_vld => dout_1_1_vld
              );

  din_1_1_re_dly_signed <= signed(din_1_1_re_dly);

  din_re <= resize(din_1_1_re_dly_signed, 25);

  intdelay_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      dinXTwdl_re <= to_signed(16#0000000#, 25);
  ...
  din_im <= resize(din_1_1_im_dly_signed, 25);

  intdelay_1_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      dinXTwdl_im <= to_signed(16#0000000#, 25);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        dinXTwdl_im <= din_im;
      END IF;
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        ...
        Radix22ButterflyG1_btf1_re_reg <= resize(Radix22ButterflyG1_x_re_dly1, 26) + resize(Radix22ButterflyG1_dinXtwdl_re_dly2, 26);
        Radix22ButterflyG1_btf2_re_reg <= resize(Radix22ButterflyG1_x_re_dly1, 26) - resize(Radix22ButterflyG1_dinXtwdl_re_dly2, 26);
        Radix22ButterflyG1_btf1_im_reg <= resize(Radix22ButterflyG1_x_im_dly1, 26) + resize(Radix22ButterflyG1_dinXtwdl_im_dly2, 26);
        Radix22ButterflyG1_btf2_im_reg <= resize(Radix22ButterflyG1_x_im_dly1, 26) - resize(Radix22ButterflyG1_dinXtwdl_im_dly2, 26);
