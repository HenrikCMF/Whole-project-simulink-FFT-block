-- -------------------------------------------------------------
-- 
-- File Name: C:\dokumenter\FFTblock\simulinktest\RADIX2FFT_bitNatural.vhd
...
-- Source Path: simulinktest/FFT_block/FFT HDL Optimized/RADIX2FFT_bitNatural
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF RADIX2FFT_bitNatural IS
  ...
  SIGNAL memOut_im                        : std_logic_vector(32 DOWNTO 0);  -- ufix33
  SIGNAL memOut_im_signed                 : signed(32 DOWNTO 0);  -- sfix33
  SIGNAL memOut_re                        : std_logic_vector(32 DOWNTO 0);  -- ufix33
  SIGNAL memOut_re_signed                 : signed(32 DOWNTO 0);  -- sfix33
  ...
  SIGNAL rdStateMachineBitNatural_doutReReg : signed(32 DOWNTO 0);  -- sfix33
  SIGNAL rdStateMachineBitNatural_doutImReg : signed(32 DOWNTO 0);  -- sfix33
  ...
  SIGNAL rdStateMachineBitNatural_doutReReg_next : signed(32 DOWNTO 0);  -- sfix33
  SIGNAL rdStateMachineBitNatural_doutImReg_next : signed(32 DOWNTO 0);  -- sfix33
  ...
  SIGNAL dout_re1_tmp                     : signed(32 DOWNTO 0);  -- sfix33
  SIGNAL dout_im1_tmp                     : signed(32 DOWNTO 0);  -- sfix33
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      ...
      rdStateMachineBitNatural_doutReReg <= to_signed(0, 33);
      rdStateMachineBitNatural_doutImReg <= to_signed(0, 33);
