-- -------------------------------------------------------------
-- 
-- File Name: C:\dokumenter\FFTblock\simulinktest\SDFCommutator9.vhd
...
-- Source Path: simulinktest/FFT_block/FFT HDL Optimized/RADIX22FFT_SDF1_9/SDFCommutator9
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF SDFCommutator9 IS
  ...
  SIGNAL SDFCummutator_btf1_re_dly        : signed(32 DOWNTO 0);  -- sfix33
  SIGNAL SDFCummutator_btf1_im_dly        : signed(32 DOWNTO 0);  -- sfix33
  ...
  SIGNAL SDFCummutator_btf1_re_dly_next   : signed(32 DOWNTO 0);  -- sfix33
  SIGNAL SDFCummutator_btf1_im_dly_next   : signed(32 DOWNTO 0);  -- sfix33
  ...
  SIGNAL dout_9_re_tmp                    : signed(32 DOWNTO 0);  -- sfix33
  SIGNAL dout_9_im_tmp                    : signed(32 DOWNTO 0);  -- sfix33
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      ...
      SDFCummutator_btf1_re_dly <= to_signed(0, 33);
      SDFCummutator_btf1_im_dly <= to_signed(0, 33);
