-- -------------------------------------------------------------
-- 
-- File Name: C:\dokumenter\FFTblock\simulinktest\SDFCommutator8.vhd
...
-- Source Path: simulinktest/FFT_block/FFT HDL Optimized/RADIX22FFT_SDF2_8/SDFCommutator8
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF SDFCommutator8 IS
  ...
  -- Signals
  SIGNAL xf_re_signed                     : signed(31 DOWNTO 0);  -- sfix32
  SIGNAL xf_im_signed                     : signed(31 DOWNTO 0);  -- sfix32
  SIGNAL dinf_re_signed                   : signed(31 DOWNTO 0);  -- sfix32
  SIGNAL dinf_im_signed                   : signed(31 DOWNTO 0);  -- sfix32
  SIGNAL btf1_re_signed                   : signed(31 DOWNTO 0);  -- sfix32
  SIGNAL btf1_im_signed                   : signed(31 DOWNTO 0);  -- sfix32
  SIGNAL btf2_re_signed                   : signed(31 DOWNTO 0);  -- sfix32
  SIGNAL btf2_im_signed                   : signed(31 DOWNTO 0);  -- sfix32
  ...
  SIGNAL wrData_re_tmp                    : signed(31 DOWNTO 0);  -- sfix32
  SIGNAL wrData_im_tmp                    : signed(31 DOWNTO 0);  -- sfix32
  ...
  SIGNAL xX_re_signed                     : signed(31 DOWNTO 0);  -- sfix32
  SIGNAL xX_im                            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL xX_im_signed                     : signed(31 DOWNTO 0);  -- sfix32
  ...
  SIGNAL dout_8_1_re_tmp                  : signed(31 DOWNTO 0);  -- sfix32
  SIGNAL dout_8_1_im_tmp                  : signed(31 DOWNTO 0);  -- sfix32
