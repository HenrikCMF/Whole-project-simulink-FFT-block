-- -------------------------------------------------------------
-- 
-- File Name: C:\dokumenter\FFTblock\simulinktest\RADIX22FFT_SDF2_2.vhd
...
-- Source Path: simulinktest/FFT_block/FFT HDL Optimized/RADIX22FFT_SDF2_2
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF RADIX22FFT_SDF2_2 IS
  ...
  COMPONENT SDFCommutator2
    PORT( clk                             :   IN    std_logic;
          ...
          xf_vld                          :   IN    std_logic;
          dinf_re                         :   IN    std_logic_vector(25 DOWNTO 0);  -- sfix26
          dinf_im                         :   IN    std_logic_vector(25 DOWNTO 0);  -- sfix26
  ...
  -- Signals
  SIGNAL dout_1_1_re_signed               : signed(24 DOWNTO 0);  -- sfix25
  SIGNAL din_re                           : signed(25 DOWNTO 0);  -- sfix26
  SIGNAL dout_1_1_im_signed               : signed(24 DOWNTO 0);  -- sfix25
  ...
  SIGNAL dinf_im                          : signed(25 DOWNTO 0);  -- sfix26
  SIGNAL dinf_re                          : signed(25 DOWNTO 0);  -- sfix26
  ...
  SIGNAL x_im_signed                      : signed(25 DOWNTO 0);  -- sfix26
  SIGNAL x_im_dly                         : signed(25 DOWNTO 0);  -- sfix26
  SIGNAL wrData_re                        : std_logic_vector(25 DOWNTO 0);  -- ufix26
  SIGNAL x_re                             : std_logic_vector(25 DOWNTO 0);  -- ufix26
  SIGNAL x_re_signed                      : signed(25 DOWNTO 0);  -- sfix26
  SIGNAL x_re_dly                         : signed(25 DOWNTO 0);  -- sfix26
  ...
  SIGNAL Radix22ButterflyG2_btf1_re_reg_next : signed(26 DOWNTO 0);  -- sfix27
  SIGNAL Radix22ButterflyG2_btf1_im_reg_next : signed(26 DOWNTO 0);  -- sfix27
  SIGNAL Radix22ButterflyG2_btf2_re_reg_next : signed(26 DOWNTO 0);  -- sfix27
  SIGNAL Radix22ButterflyG2_btf2_im_reg_next : signed(26 DOWNTO 0);  -- sfix27
  SIGNAL Radix22ButterflyG2_din_re_dly_next : signed(25 DOWNTO 0);  -- sfix26
  SIGNAL Radix22ButterflyG2_din_im_dly_next : signed(25 DOWNTO 0);  -- sfix26
  SIGNAL Radix22ButterflyG2_din_vld_dly_next : std_logic;
  SIGNAL Radix22ButterflyG2_x_re_dly_next : signed(25 DOWNTO 0);  -- sfix26
  SIGNAL Radix22ButterflyG2_x_im_dly_next : signed(25 DOWNTO 0);  -- sfix26
  SIGNAL Radix22ButterflyG2_x_vld_dly_next : std_logic;
  SIGNAL Radix22ButterflyG2_dinXTwdl_re_dly1_next : signed(25 DOWNTO 0);  -- sfix26
  SIGNAL Radix22ButterflyG2_dinXTwdl_im_dly1_next : signed(25 DOWNTO 0);  -- sfix26
  SIGNAL Radix22ButterflyG2_dinXTwdl_re_dly2_next : signed(25 DOWNTO 0);  -- sfix26
  SIGNAL Radix22ButterflyG2_dinXTwdl_im_dly2_next : signed(25 DOWNTO 0);  -- sfix26
  ...
  SIGNAL dout_2_1_re_tmp                  : std_logic_vector(25 DOWNTO 0);  -- ufix26
  SIGNAL dout_2_1_im_tmp                  : std_logic_vector(25 DOWNTO 0);  -- ufix26
...
BEGIN
  ...
  u_SDFCOMMUTATOR_2 : SDFCommutator2
    PORT MAP( clk => clk,
              ...
              xf_vld => xf_vld,
              dinf_re => std_logic_vector(dinf_re),  -- sfix26
              dinf_im => std_logic_vector(dinf_im),  -- sfix26
              dinf_vld => dinf_vld,
              ...
              wrAddr => wrAddr,  -- ufix7
              wrEnb => wrEnb,
              dout_2_1_re => dout_2_1_re_tmp,  -- sfix26
              dout_2_1_im => dout_2_1_im_tmp,  -- sfix26
              dout_2_1_vld => dout_2_1_vld
              );

  dout_1_1_re_signed <= signed(dout_1_1_re);

  din_re <= resize(dout_1_1_re_signed, 26);

  dout_1_1_im_signed <= signed(dout_1_1_im);

  din_im <= resize(dout_1_1_im_signed, 26);
  ...
  BEGIN
    ...
    IF Radix22ButterflyG2_multiply_J_dly1 = '1' THEN 
      Radix22ButterflyG2_btf1_re_reg_next <= resize(x_re_dly, 27) + resize(Radix22ButterflyG2_dinXTwdl_im_dly2, 27);
      Radix22ButterflyG2_btf2_re_reg_next <= resize(x_re_dly, 27) - resize(Radix22ButterflyG2_dinXTwdl_im_dly2, 27);
      Radix22ButterflyG2_btf2_im_reg_next <= resize(x_im_dly, 27) + resize(Radix22ButterflyG2_dinXTwdl_re_dly2, 27);
      Radix22ButterflyG2_btf1_im_reg_next <= resize(x_im_dly, 27) - resize(Radix22ButterflyG2_dinXTwdl_re_dly2, 27);
    ELSE 
      Radix22ButterflyG2_btf1_re_reg_next <= resize(x_re_dly, 27) + resize(Radix22ButterflyG2_dinXTwdl_re_dly2, 27);
      Radix22ButterflyG2_btf2_re_reg_next <= resize(x_re_dly, 27) - resize(Radix22ButterflyG2_dinXTwdl_re_dly2, 27);
      Radix22ButterflyG2_btf1_im_reg_next <= resize(x_im_dly, 27) + resize(Radix22ButterflyG2_dinXTwdl_im_dly2, 27);
      Radix22ButterflyG2_btf2_im_reg_next <= resize(x_im_dly, 27) - resize(Radix22ButterflyG2_dinXTwdl_im_dly2, 27);
    END IF;
