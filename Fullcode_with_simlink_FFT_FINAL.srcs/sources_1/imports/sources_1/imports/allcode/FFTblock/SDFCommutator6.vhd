-- -------------------------------------------------------------
-- 
-- File Name: C:\dokumenter\FFTblock\simulinktest\SDFCommutator6.vhd
...
-- Source Path: simulinktest/FFT_block/FFT HDL Optimized/RADIX22FFT_SDF2_6/SDFCommutator6
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF SDFCommutator6 IS
  ...
  -- Signals
  SIGNAL xf_re_signed                     : signed(29 DOWNTO 0);  -- sfix30
  SIGNAL xf_im_signed                     : signed(29 DOWNTO 0);  -- sfix30
  SIGNAL dinf_re_signed                   : signed(29 DOWNTO 0);  -- sfix30
  SIGNAL dinf_im_signed                   : signed(29 DOWNTO 0);  -- sfix30
  SIGNAL btf1_re_signed                   : signed(29 DOWNTO 0);  -- sfix30
  SIGNAL btf1_im_signed                   : signed(29 DOWNTO 0);  -- sfix30
  SIGNAL btf2_re_signed                   : signed(29 DOWNTO 0);  -- sfix30
  SIGNAL btf2_im_signed                   : signed(29 DOWNTO 0);  -- sfix30
  ...
  SIGNAL SDFCummutator_out_re_next        : signed(29 DOWNTO 0);  -- sfix30
  SIGNAL SDFCummutator_out_im_next        : signed(29 DOWNTO 0);  -- sfix30
  ...
  SIGNAL SDFCummutator_wrData_re_reg_next : signed(29 DOWNTO 0);  -- sfix30
  SIGNAL SDFCummutator_wrData_im_reg_next : signed(29 DOWNTO 0);  -- sfix30
  SIGNAL SDFCummutator_wrEnb_reg_next     : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg_next : signed(29 DOWNTO 0);  -- sfix30
  SIGNAL SDFCummutator_wrXData_im_reg_next : signed(29 DOWNTO 0);  -- sfix30
  ...
  SIGNAL wrData_re_tmp                    : signed(29 DOWNTO 0);  -- sfix30
  SIGNAL wrData_im_tmp                    : signed(29 DOWNTO 0);  -- sfix30
  SIGNAL wrAddr_tmp                       : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL xData_re                         : signed(29 DOWNTO 0);  -- sfix30
  SIGNAL xData_im                         : signed(29 DOWNTO 0);  -- sfix30
  ...
  SIGNAL dout0_re                         : signed(29 DOWNTO 0);  -- sfix30
  SIGNAL dout0_im                         : signed(29 DOWNTO 0);  -- sfix30
  SIGNAL dout0_vld                        : std_logic;
  SIGNAL xX_re                            : std_logic_vector(29 DOWNTO 0);  -- ufix30
  SIGNAL xX_re_signed                     : signed(29 DOWNTO 0);  -- sfix30
  SIGNAL xX_im                            : std_logic_vector(29 DOWNTO 0);  -- ufix30
  SIGNAL xX_im_signed                     : signed(29 DOWNTO 0);  -- sfix30
  ...
  SIGNAL SDFOutmux_btf2Pipe_re_next       : signed(29 DOWNTO 0);  -- sfix30
  SIGNAL SDFOutmux_btf2Pipe_im_next       : signed(29 DOWNTO 0);  -- sfix30
  SIGNAL SDFOutmux_btfPipe_vld_next       : std_logic;
  SIGNAL dout_6_1_re_tmp                  : signed(29 DOWNTO 0);  -- sfix30
  SIGNAL dout_6_1_im_tmp                  : signed(29 DOWNTO 0);  -- sfix30
