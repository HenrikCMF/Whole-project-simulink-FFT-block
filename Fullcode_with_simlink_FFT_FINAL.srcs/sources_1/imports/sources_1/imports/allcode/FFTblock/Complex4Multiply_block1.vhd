-- -------------------------------------------------------------
-- 
-- File Name: C:\dokumenter\FFTblock\simulinktest\Complex4Multiply_block1.vhd
...
-- Source Path: simulinktest/FFT_block/FFT HDL Optimized/RADIX22FFT_SDF1_7/Complex4Multiply
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF Complex4Multiply_block1 IS
  ...
  -- Signals
  SIGNAL din_re_signed                    : signed(30 DOWNTO 0);  -- sfix31
  SIGNAL din_re_reg                       : signed(30 DOWNTO 0);  -- sfix31
  SIGNAL din_im_signed                    : signed(30 DOWNTO 0);  -- sfix31
  SIGNAL din_im_reg                       : signed(30 DOWNTO 0);  -- sfix31
  SIGNAL twdl_7_1_re_signed               : signed(23 DOWNTO 0);  -- sfix24_En22
  SIGNAL twdl_re_reg                      : signed(23 DOWNTO 0);  -- sfix24_En22
  SIGNAL twdl_7_1_im_signed               : signed(23 DOWNTO 0);  -- sfix24_En22
  ...
  SIGNAL Complex4Multiply_mult1_re_pipe1  : signed(54 DOWNTO 0) := to_signed(0, 55);  -- sfix55
  SIGNAL Complex4Multiply_mult2_re_pipe1  : signed(54 DOWNTO 0) := to_signed(0, 55);  -- sfix55
  SIGNAL Complex4Multiply_mult1_im_pipe1  : signed(54 DOWNTO 0) := to_signed(0, 55);  -- sfix55
  SIGNAL Complex4Multiply_mult2_im_pipe1  : signed(54 DOWNTO 0) := to_signed(0, 55);  -- sfix55
  ...
  SIGNAL prod1_re                         : signed(54 DOWNTO 0) := to_signed(0, 55);  -- sfix55_En22
  SIGNAL prod1_im                         : signed(54 DOWNTO 0) := to_signed(0, 55);  -- sfix55_En22
  SIGNAL prod2_re                         : signed(54 DOWNTO 0) := to_signed(0, 55);  -- sfix55_En22
  SIGNAL prod2_im                         : signed(54 DOWNTO 0) := to_signed(0, 55);  -- sfix55_En22
  SIGNAL din_vld_dly1                     : std_logic;
  SIGNAL din_vld_dly2                     : std_logic;
  SIGNAL din_vld_dly3                     : std_logic;
  SIGNAL prod_vld                         : std_logic;
  SIGNAL Complex4Add_multRes_re_reg       : signed(55 DOWNTO 0);  -- sfix56
  SIGNAL Complex4Add_multRes_im_reg       : signed(55 DOWNTO 0);  -- sfix56
  SIGNAL Complex4Add_prod_vld_reg1        : std_logic;
  SIGNAL Complex4Add_prod1_re_reg         : signed(54 DOWNTO 0);  -- sfix55
  SIGNAL Complex4Add_prod1_im_reg         : signed(54 DOWNTO 0);  -- sfix55
  SIGNAL Complex4Add_prod2_re_reg         : signed(54 DOWNTO 0);  -- sfix55
  SIGNAL Complex4Add_prod2_im_reg         : signed(54 DOWNTO 0);  -- sfix55
  SIGNAL Complex4Add_multRes_re_reg_next  : signed(55 DOWNTO 0);  -- sfix56_En22
  SIGNAL Complex4Add_multRes_im_reg_next  : signed(55 DOWNTO 0);  -- sfix56_En22
  SIGNAL Complex4Add_sub_cast             : signed(55 DOWNTO 0);  -- sfix56_En22
  SIGNAL Complex4Add_sub_cast_1           : signed(55 DOWNTO 0);  -- sfix56_En22
  SIGNAL Complex4Add_add_cast             : signed(55 DOWNTO 0);  -- sfix56_En22
  SIGNAL Complex4Add_add_cast_1           : signed(55 DOWNTO 0);  -- sfix56_En22
  SIGNAL mulResFP_re                      : signed(55 DOWNTO 0);  -- sfix56_En22
  SIGNAL mulResFP_im                      : signed(55 DOWNTO 0);  -- sfix56_En22
  SIGNAL dinXTwdl_re_tmp                  : signed(30 DOWNTO 0);  -- sfix31
  SIGNAL dinXTwdl_im_tmp                  : signed(30 DOWNTO 0);  -- sfix31
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      Complex4Add_multRes_re_reg <= to_signed(0, 56);
      Complex4Add_multRes_im_reg <= to_signed(0, 56);
      Complex4Add_prod1_re_reg <= to_signed(0, 55);
      Complex4Add_prod1_im_reg <= to_signed(0, 55);
      Complex4Add_prod2_re_reg <= to_signed(0, 55);
      Complex4Add_prod2_im_reg <= to_signed(0, 55);
  ...
  Complex4Add_sub_cast <= resize(Complex4Add_prod1_re_reg, 56);
  Complex4Add_sub_cast_1 <= resize(Complex4Add_prod2_re_reg, 56);
  Complex4Add_multRes_re_reg_next <= Complex4Add_sub_cast - Complex4Add_sub_cast_1;
  Complex4Add_add_cast <= resize(Complex4Add_prod1_im_reg, 56);
  Complex4Add_add_cast_1 <= resize(Complex4Add_prod2_im_reg, 56);
  ...
  dinXTwdl_re_tmp <= mulResFP_re(52 DOWNTO 22);

  dinXTwdl_re <= std_logic_vector(dinXTwdl_re_tmp);

  dinXTwdl_im_tmp <= mulResFP_im(52 DOWNTO 22);
