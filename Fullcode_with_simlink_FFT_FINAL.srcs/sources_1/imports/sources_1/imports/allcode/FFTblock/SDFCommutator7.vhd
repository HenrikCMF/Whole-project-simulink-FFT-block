-- -------------------------------------------------------------
-- 
-- File Name: C:\dokumenter\FFTblock\simulinktest\SDFCommutator7.vhd
...
-- Source Path: simulinktest/FFT_block/FFT HDL Optimized/RADIX22FFT_SDF1_7/SDFCommutator7
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF SDFCommutator7 IS
  ...
  -- Signals
  SIGNAL xf_re_signed                     : signed(30 DOWNTO 0);  -- sfix31
  SIGNAL xf_im_signed                     : signed(30 DOWNTO 0);  -- sfix31
  SIGNAL dinXTwdlf_re_signed              : signed(30 DOWNTO 0);  -- sfix31
  SIGNAL dinXTwdlf_im_signed              : signed(30 DOWNTO 0);  -- sfix31
  SIGNAL btf1_re_signed                   : signed(30 DOWNTO 0);  -- sfix31
  SIGNAL btf1_im_signed                   : signed(30 DOWNTO 0);  -- sfix31
  SIGNAL btf2_re_signed                   : signed(30 DOWNTO 0);  -- sfix31
  SIGNAL btf2_im_signed                   : signed(30 DOWNTO 0);  -- sfix31
  ...
  SIGNAL SDFCummutator_out_re_next        : signed(30 DOWNTO 0);  -- sfix31
  SIGNAL SDFCummutator_out_im_next        : signed(30 DOWNTO 0);  -- sfix31
  ...
  SIGNAL SDFCummutator_wrData_re_reg_next : signed(30 DOWNTO 0);  -- sfix31
  SIGNAL SDFCummutator_wrData_im_reg_next : signed(30 DOWNTO 0);  -- sfix31
  SIGNAL SDFCummutator_wrEnb_reg_next     : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg_next : signed(30 DOWNTO 0);  -- sfix31
  SIGNAL SDFCummutator_wrXData_im_reg_next : signed(30 DOWNTO 0);  -- sfix31
  ...
  SIGNAL wrData_re_tmp                    : signed(30 DOWNTO 0);  -- sfix31
  SIGNAL wrData_im_tmp                    : signed(30 DOWNTO 0);  -- sfix31
  SIGNAL wrAddr_tmp                       : unsigned(1 DOWNTO 0);  -- ufix2
  SIGNAL xData_re                         : signed(30 DOWNTO 0);  -- sfix31
  SIGNAL xData_im                         : signed(30 DOWNTO 0);  -- sfix31
  ...
  SIGNAL dout0_re                         : signed(30 DOWNTO 0);  -- sfix31
  SIGNAL dout0_im                         : signed(30 DOWNTO 0);  -- sfix31
  SIGNAL dout0_vld                        : std_logic;
  SIGNAL xX_re                            : std_logic_vector(30 DOWNTO 0);  -- ufix31
  SIGNAL xX_re_signed                     : signed(30 DOWNTO 0);  -- sfix31
  SIGNAL xX_im                            : std_logic_vector(30 DOWNTO 0);  -- ufix31
  SIGNAL xX_im_signed                     : signed(30 DOWNTO 0);  -- sfix31
  ...
  SIGNAL SDFOutmux_btf2Pipe_re_next       : signed(30 DOWNTO 0);  -- sfix31
  SIGNAL SDFOutmux_btf2Pipe_im_next       : signed(30 DOWNTO 0);  -- sfix31
  SIGNAL SDFOutmux_btfPipe_vld_next       : std_logic;
  SIGNAL dout_7_1_re_tmp                  : signed(30 DOWNTO 0);  -- sfix31
  SIGNAL dout_7_1_im_tmp                  : signed(30 DOWNTO 0);  -- sfix31
