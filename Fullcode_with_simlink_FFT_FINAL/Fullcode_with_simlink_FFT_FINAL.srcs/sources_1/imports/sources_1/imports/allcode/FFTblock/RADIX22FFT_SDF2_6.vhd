-- -------------------------------------------------------------
-- 
-- File Name: C:\dokumenter\FFTblock\simulinktest\RADIX22FFT_SDF2_6.vhd
...
-- Source Path: simulinktest/FFT_block/FFT HDL Optimized/RADIX22FFT_SDF2_6
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF RADIX22FFT_SDF2_6 IS
  ...
  COMPONENT SDFCommutator6
    PORT( clk                             :   IN    std_logic;
          ...
          enb                             :   IN    std_logic;
          dout_5_1_vld                    :   IN    std_logic;
          xf_re                           :   IN    std_logic_vector(29 DOWNTO 0);  -- sfix30
          xf_im                           :   IN    std_logic_vector(29 DOWNTO 0);  -- sfix30
          xf_vld                          :   IN    std_logic;
          dinf_re                         :   IN    std_logic_vector(29 DOWNTO 0);  -- sfix30
          dinf_im                         :   IN    std_logic_vector(29 DOWNTO 0);  -- sfix30
          dinf_vld                        :   IN    std_logic;
          btf1_re                         :   IN    std_logic_vector(29 DOWNTO 0);  -- sfix30
          btf1_im                         :   IN    std_logic_vector(29 DOWNTO 0);  -- sfix30
          btf2_re                         :   IN    std_logic_vector(29 DOWNTO 0);  -- sfix30
          btf2_im                         :   IN    std_logic_vector(29 DOWNTO 0);  -- sfix30
          btfout_vld                      :   IN    std_logic;
          wrData_re                       :   OUT   std_logic_vector(29 DOWNTO 0);  -- sfix30
          wrData_im                       :   OUT   std_logic_vector(29 DOWNTO 0);  -- sfix30
  ...
  -- Signals
  SIGNAL dout_5_1_re_signed               : signed(28 DOWNTO 0);  -- sfix29
  SIGNAL din_re                           : signed(29 DOWNTO 0);  -- sfix30
  SIGNAL dout_5_1_im_signed               : signed(28 DOWNTO 0);  -- sfix29
  SIGNAL din_im                           : signed(29 DOWNTO 0);  -- sfix30
  ...
  SIGNAL btf2_im                          : signed(29 DOWNTO 0);  -- sfix30
  SIGNAL btf2_re                          : signed(29 DOWNTO 0);  -- sfix30
  SIGNAL btf1_im                          : signed(29 DOWNTO 0);  -- sfix30
  SIGNAL btf1_re                          : signed(29 DOWNTO 0);  -- sfix30
  SIGNAL dinf_im                          : signed(29 DOWNTO 0);  -- sfix30
  SIGNAL dinf_re                          : signed(29 DOWNTO 0);  -- sfix30
  SIGNAL xf_im                            : signed(29 DOWNTO 0);  -- sfix30
  ...
  SIGNAL x_im_signed                      : signed(29 DOWNTO 0);  -- sfix30
  SIGNAL x_im_dly                         : signed(29 DOWNTO 0);  -- sfix30
  SIGNAL wrData_re                        : std_logic_vector(29 DOWNTO 0);  -- ufix30
  SIGNAL x_re                             : std_logic_vector(29 DOWNTO 0);  -- ufix30
  SIGNAL x_re_signed                      : signed(29 DOWNTO 0);  -- sfix30
  SIGNAL x_re_dly                         : signed(29 DOWNTO 0);  -- sfix30
  ...
  SIGNAL Radix22ButterflyG2_btf1_re_reg_next : signed(30 DOWNTO 0);  -- sfix31
  SIGNAL Radix22ButterflyG2_btf1_im_reg_next : signed(30 DOWNTO 0);  -- sfix31
  SIGNAL Radix22ButterflyG2_btf2_re_reg_next : signed(30 DOWNTO 0);  -- sfix31
  SIGNAL Radix22ButterflyG2_btf2_im_reg_next : signed(30 DOWNTO 0);  -- sfix31
  SIGNAL Radix22ButterflyG2_din_re_dly_next : signed(29 DOWNTO 0);  -- sfix30
  SIGNAL Radix22ButterflyG2_din_im_dly_next : signed(29 DOWNTO 0);  -- sfix30
  SIGNAL Radix22ButterflyG2_din_vld_dly_next : std_logic;
  SIGNAL Radix22ButterflyG2_x_re_dly_next : signed(29 DOWNTO 0);  -- sfix30
  SIGNAL Radix22ButterflyG2_x_im_dly_next : signed(29 DOWNTO 0);  -- sfix30
  SIGNAL Radix22ButterflyG2_x_vld_dly_next : std_logic;
  SIGNAL Radix22ButterflyG2_dinXTwdl_re_dly1_next : signed(29 DOWNTO 0);  -- sfix30
  SIGNAL Radix22ButterflyG2_dinXTwdl_im_dly1_next : signed(29 DOWNTO 0);  -- sfix30
  SIGNAL Radix22ButterflyG2_dinXTwdl_re_dly2_next : signed(29 DOWNTO 0);  -- sfix30
  SIGNAL Radix22ButterflyG2_dinXTwdl_im_dly2_next : signed(29 DOWNTO 0);  -- sfix30
  SIGNAL Radix22ButterflyG2_multiply_J_dly1_next : std_logic;
  SIGNAL xf_re                            : signed(29 DOWNTO 0);  -- sfix30
  SIGNAL xf_vld                           : std_logic;
  SIGNAL dinf_vld                         : std_logic;
  SIGNAL btfout_vld                       : std_logic;
  SIGNAL dout_6_1_re_tmp                  : std_logic_vector(29 DOWNTO 0);  -- ufix30
  SIGNAL dout_6_1_im_tmp                  : std_logic_vector(29 DOWNTO 0);  -- ufix30
...
BEGIN
  ...
  u_SDFCOMMUTATOR_6 : SDFCommutator6
    PORT MAP( clk => clk,
              ...
              xf_re => std_logic_vector(xf_re),  -- sfix30
              xf_im => std_logic_vector(xf_im),  -- sfix30
              xf_vld => xf_vld,
              dinf_re => std_logic_vector(dinf_re),  -- sfix30
              dinf_im => std_logic_vector(dinf_im),  -- sfix30
              dinf_vld => dinf_vld,
              btf1_re => std_logic_vector(btf1_re),  -- sfix30
              btf1_im => std_logic_vector(btf1_im),  -- sfix30
              btf2_re => std_logic_vector(btf2_re),  -- sfix30
              btf2_im => std_logic_vector(btf2_im),  -- sfix30
              btfout_vld => btfout_vld,
              wrData_re => wrData_re,  -- sfix30
              wrData_im => wrData_im,  -- sfix30
              wrAddr => wrAddr,  -- ufix3
              wrEnb => wrEnb,
              dout_6_1_re => dout_6_1_re_tmp,  -- sfix30
              dout_6_1_im => dout_6_1_im_tmp,  -- sfix30
              dout_6_1_vld => dout_6_1_vld
              );

  dout_5_1_re_signed <= signed(dout_5_1_re);

  din_re <= resize(dout_5_1_re_signed, 30);

  dout_5_1_im_signed <= signed(dout_5_1_im);

  din_im <= resize(dout_5_1_im_signed, 30);
  ...
  BEGIN
    ...
    IF Radix22ButterflyG2_multiply_J_dly1 = '1' THEN 
      Radix22ButterflyG2_btf1_re_reg_next <= resize(x_re_dly, 31) + resize(Radix22ButterflyG2_dinXTwdl_im_dly2, 31);
      Radix22ButterflyG2_btf2_re_reg_next <= resize(x_re_dly, 31) - resize(Radix22ButterflyG2_dinXTwdl_im_dly2, 31);
      Radix22ButterflyG2_btf2_im_reg_next <= resize(x_im_dly, 31) + resize(Radix22ButterflyG2_dinXTwdl_re_dly2, 31);
      Radix22ButterflyG2_btf1_im_reg_next <= resize(x_im_dly, 31) - resize(Radix22ButterflyG2_dinXTwdl_re_dly2, 31);
    ELSE 
      Radix22ButterflyG2_btf1_re_reg_next <= resize(x_re_dly, 31) + resize(Radix22ButterflyG2_dinXTwdl_re_dly2, 31);
      Radix22ButterflyG2_btf2_re_reg_next <= resize(x_re_dly, 31) - resize(Radix22ButterflyG2_dinXTwdl_re_dly2, 31);
      Radix22ButterflyG2_btf1_im_reg_next <= resize(x_im_dly, 31) + resize(Radix22ButterflyG2_dinXTwdl_im_dly2, 31);
      Radix22ButterflyG2_btf2_im_reg_next <= resize(x_im_dly, 31) - resize(Radix22ButterflyG2_dinXTwdl_im_dly2, 31);
    END IF;
