-- -------------------------------------------------------------
-- 
-- File Name: C:\dokumenter\FFTblock\simulinktest\SDFCommutator1.vhd
...
-- Source Path: simulinktest/FFT_block/FFT HDL Optimized/RADIX22FFT_SDF1_1/SDFCommutator1
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF SDFCommutator1 IS
  ...
  SIGNAL dinXTwdlf_re_signed              : signed(24 DOWNTO 0);  -- sfix25
  SIGNAL dinXTwdlf_im_signed              : signed(24 DOWNTO 0);  -- sfix25
  ...
  SIGNAL wrData_im                        : signed(24 DOWNTO 0);  -- sfix25
  ...
  SIGNAL dout_1_1_re_tmp                  : signed(24 DOWNTO 0);  -- sfix25
  SIGNAL dout_1_1_im_tmp                  : signed(24 DOWNTO 0);  -- sfix25
